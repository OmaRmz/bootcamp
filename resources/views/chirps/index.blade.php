<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <form method="POST" action="{{ route('chirps.store') }}">
                        ...
                        <textarea name="message" 
                            class="block w-full rounded-md border-gray-300 bg-white shadow-sm transition-colors duration-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50
                                dark:border-gray-600 dark_bg-gray-800 dark:text-black dark:focus:border-indigo-300 dark:focus:ring dark:focus:ring-indigo-200 dark:focus:ring-opacity-50"
            ...
            <div class="mt-6 bg-white dark:bg-gray-800 shadow-sm rounded-lg divided-y dark:divide-gray-900">
                @foreach($chirps as $chirp)
                <div class="h6 flex space-x-2">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between itesms-center">
                            <div>
                                <span class="text-gray-800 dark:text-gray-200">{{ $chirp->user->name }}</span>
                                <small class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ $chirp->created_at->format('j M Y, ') }}</small>
